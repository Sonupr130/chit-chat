    ...
    <div className={`h-screen w-screen flex ${darkMode ? 'bg-gray-900 text-white' : 'bg-[#f9f7fd] text-gray-800'} overflow-hidden transition-colors duration-300`}>
      ...
      <div className={`flex flex-col items-center justify-between py-10 w-[8vw] ${darkMode ? 'bg-gray-800' : 'bg-[#f9f7fd]'}`}>
        ...
        <div className="flex flex-col items-center gap-4">
          ...
          <button className={`${darkMode ? 'text-red-400 hover:text-red-300' : 'text-red-600 hover:text-red-800'} transition-colors bg-white p-3 rounded-full cursor-pointer shadow-2xl hover:shadow-2xl ${darkMode ? 'hover:shadow-red-400' : 'hover:shadow-red-500'}`}>
            <LogOut size={20} />
          </button>
        </div>
      </div>
